...
public class InterfaceGUI extends JFrame{
	...
	private static int ogresDefaultNumber=1;
	...
	private final JMenuItem mntmMainMenu = new JMenuItem("Main Menu");
	...
	private void actionListeners3(){
		btnOptions.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				option.setvisible(true); }  });
		btnOptions.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O, InputEvent.CTRL_MASK));
		btnNewGame.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				gameEngine= new GameEngine();
				gameEngine.reinitialize();
